...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Deck = __webpack_require__(160);
	var Characters = __webpack_require__(161);
	var UserQuery = __webpack_require__(163);
	...
	var Game = React.createClass({
	  ...
	  render: function render() {
	    var lastQueryResponseElem = React.createElement(
	      'p',
	      { className: 'yellow query' },
	    ...
	    var guessWrongResponse = 'ARE YOU CRAZY? ' + this.state.userGuess.name.toUpperCase() + ' SUCKS!! GO AWAY.';
	    var guessRightResponse = 'THAT\'S RIGHT! ' + this.state.userGuess.name.toUpperCase() + ' IS THE BEST. WAR ' + this.state.userGuess.name.toUpperCase() + '!';
	    ...
	    if (this.state.guessMade === true) {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(Deck, { characters: this.state.deck })
	      );
	    }
	  },
	
	  topFormSubmit: function topFormSubmit(key, bool) {
	    //check answer
	    var selectedChar = this.state.deck[this.state.selected];
	    var checkAttr = selectedChar[key];
	    if (checkAttr === bool) {
	  ...
	  setUserGuess: function setUserGuess(name) {
	    var guess = this.state.deck.find(function (character) {
	      return character.name === name;
	    });
	    this.setState({ userGuess: guess });
	  },
	
	  handleUserGuess: function handleUserGuess() {
	    this.setState({ guessMade: true });
	    this.checkGuessCorrect();
	  },
	
	  checkGuessCorrect: function checkGuessCorrect() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Deck = React.createClass({
	  ...
	  render: function render() {
	    var characterElems = this.props.characters.map(function (character) {
	      return React.createElement(
	        'div',
	        { className: 'deck', key: character.name },
	        React.createElement(Character, { character: character })
	      );
	    });
...
/***/ function(module, exports) {
	...
	module.exports = [{ name: 'Balrog',
	  img: 'sf_pics/Balrog.png',
	  'Boss': 'true',
	  'Male': 'true',
	  'Female': 'false',
	  'White background': 'false',
	  'Swishy lines': 'false' }, { name: 'Chun-li',
	  img: 'sf_pics/Chun-Li.png',
	  'Boss': 'false',
	  'Male': 'false',
	  'Female': 'true',
	  'White background': 'false',
	  'Swishy lines': 'true' }, { name: 'Dhalsim',
	  img: 'sf_pics/Dhalsim.png',
	  'Boss': 'false',
	  'Male': 'true',
	  'Female': 'false',
	  'White background': 'false',
	  'Swishy lines': 'true' }, { name: 'Guile',
	  img: 'sf_pics/Guile.png',
	  'Boss': 'false',
	  'Male': 'true',
	  'Female': 'false',
	  'White background': 'false',
	  'Swishy lines': 'false' }, { name: 'Ken',
	  img: 'sf_pics/Ken.png',
	  'Boss': 'false',
	  'Male': 'true',
	  'Female': 'false',
	  'White background': 'false',
	  'Swishy lines': 'true' }, { name: 'M. Bison',
	  img: 'sf_pics/M_Bison.png',
	  'Boss': 'true',
	  'Male': 'true',
	  'Female': 'false',
	  'White background': 'false',
	  'Swishy lines': 'true' }, { name: 'Ryu',
	  img: 'sf_pics/Ryu.png',
	  'Boss': 'false',
	  'Male': 'true',
	  'Female': 'false',
	  'White background': 'false',
	  'Swishy lines': 'true' }, { name: 'Vega',
	  img: 'sf_pics/Vega.png',
	  'Boss': 'true',
	  'Male': 'true',
	  'Female': 'false',
	  'White background': 'false',
	  'Swishy lines': 'true' }, { name: 'Zangief',
	  img: 'sf_pics/Zangief.png',
	  'Boss': 'false',
	  'Male': 'true',
	  'Female': 'false',
	  'White background': 'false',
	  'Swishy lines': 'true' }, { name: 'Blanka',
	  img: 'sf_pics/Blanka.jpg',
	  'Boss': 'false',
	  'Male': 'true',
	  'Female': 'false',
	  'White background': 'true',
	  'Swishy lines': 'false' }, { name: 'Honda',
	  img: 'sf_pics/Honda.jpg',
	  'Boss': 'false',
	  'Male': 'true',
	  'Female': 'false',
	  'White background': 'true',
	  'Swishy lines': 'false' }, { name: 'Sagat',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Character = React.createClass({
	  ...
	  render: function render() {
	    var src = this.props.character.img;
	    return React.createElement(
	      'div',
	      { className: 'char' },
	      React.createElement('img', { className: 'char', src: src }),
	      React.createElement(
	        'p',
	        { className: 'yellow' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserQuery = React.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    var filteredOptions = this.props.queries.filter(function (query) {
	  ...
	  render: function render() {
	    ...
	    var queryOptions = filteredOptions.map(function (query) {
	      return React.createElement(
	        'option',
	    ...
	    var nameOptions = this.props.characters.map(function (name) {
	      return React.createElement(
	        'option',
	        { key: name, value: name },
	        name
	    ...
	    var displayElement = React.createElement(
	      'form',
	      { className: 'form', onSubmit: this.takeGuess },
	      React.createElement(
	        'label',
	        { className: 'yellow' },
	        'Your guess:'
	    ...
	    var topForm = React.createElement(
	      'form',
	      { className: 'form', onSubmit: this.topFormSubmit },
	      React.createElement(
	        'select',
	  ...
	  handleGuessChange: function handleGuessChange(e) {
	    this.props.setUserGuess(e.target.value);
	  },
	
	  takeGuess: function takeGuess(e) {
	    e.preventDefault();
	    this.props.handleUserGuess();
	  },
	
	  userReady: function userReady(e) {
	    e.preventDefault();
	    this.setState({ readyToGuess: true });
	  },
	
	  onQuerySelect: function onQuerySelect(e) {
	    this.setState({ queryVal: e.target.value });
	  },
	
	  onBoolSelect: function onBoolSelect(e) {
	    this.setState({ boolVal: e.target.value });
	  },
	
	  topFormSubmit: function topFormSubmit(e) {
	    e.preventDefault();
	...
	var Header = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('img', { className: 'guess_who_logo',
